...
const Hostcom = ()=>{
    ...
    <div className=" inline-block relative">
            <input onFocus={()=>{setPanel(true)}} onBlur={()=>{setPanel(false)}} className=" dark:bg-gray-700 dark:text-white h-10 rounded-md px-2 outline-none border border-blue-600" placeholder={$lan("proxyInput",langsource)} ></input>
    ...
    <div className=" mt-2 ml-40">
        <textarea className="dark:bg-gray-700 w-full max-w-lg p-1 h-52 dark:text-white rounded-md px-2 outline-none border border-blue-600" placeholder={$lan("requerHeader",langsource)} ></textarea> 
    </div>
</div>

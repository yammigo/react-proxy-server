    ...
    const changePath= (e)=>{
        ...
        return  (<div className="mt-6">
                    ...
                    <div className=" inline-block relative">
                            <input type="text" autoComplete="#" name="host" defaultValue={"http://www.baidu.com"} onFocus={()=>{setPanel(true)}} onBlur={()=>{setPanel(false)}} className=" dark:bg-gray-700 dark:text-white h-10 rounded-md px-2 outline-none border border-blue-600 appearance-none" placeholder={$lan("proxyInput",langsource)} ></input>
                            ...
                            <button className="ml-6 bg-blue-600 text-white active:opacity-90 h-10 px-5 rounded-md"> {panel+""}</button>
                           
                            {
                                useMemo(()=>{
                            
                                   return <dl className={" bg-white dark:bg-gray-700 rounded-md absolute p-2 shadow-md "+(panel?"":"hidden")}>
                                        {
